...
v1 的 top-level public API 包含 Gate 1 基礎與 Gate 2 治理 envelope：
...
sse-starlette 或任何 ANILA 服務套件。所有 v1 model 都是 frozen、拒絕未知欄位與
未知 schema version，且五個 v1 wire envelope 都必須明確攜帶版本；時間必須帶時區，
