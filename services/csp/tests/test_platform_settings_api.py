...
KEEP_KEYS = [
    ...
    # Router 三份 system prompt（擁有者 2026-08-22 裁定進治理中心，09-02 落地）
...
def test_overview_is_exactly_fifteen_immediate_c_rows(client, db):
...
def test_registry_has_same_count_as_api_contract():
    assert len(SETTINGS) == len(KEEP_KEYS) == 15
