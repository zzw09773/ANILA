...
```
1464 passed · 13 skipped · 0 failed     (1477 collected)
```
...
| 跑法 | cwd | 指令 | 結果 |
|---|---|---|---|
| 1 | worktree / repo 根 | `$PY -m pytest services/csp/tests -q` | 1464 passed · 13 skipped |
| 2 | `services/csp` | `$PY -m pytest tests -q` | 1464 passed · 13 skipped |
