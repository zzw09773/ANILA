...
which cloud FLUX model flux2-dev-agent / anila-studio should auto-consume
through the CSP Models page. At most one row may carry
is_image_primary=true at a time — enforced by a partial unique index.
完全比照 0008_add_is_router_primary 的既有寫法。
