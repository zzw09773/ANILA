...
from agentic_rag.engine.budget_tracker import (
    BudgetTracker,
    DIMINISHING_THRESHOLD,
    check_token_budget,
)
from agentic_rag.engine.query_engine import QueryConfig, QueryEngine
from agentic_rag.models.message import UserMessage
from agentic_rag.models.tool import ToolDefinition
from agentic_rag.providers.mock import MockProvider, ScriptedResponse, ScriptedToolCall
...
class TestQueryEngineBasicTurn:
    ...
    async def test_simple_text_response(self) -> None:
        ...
        from agentic_rag.models.message import AssistantMessage
    ...
    async def test_usage_accumulated(self) -> None:
        from agentic_rag.models.message import Usage
        script = [
            ScriptedResponse(
                text="Hi",
