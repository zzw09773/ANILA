...
將 data/documents/ 資料夾下的文件透過 AgenticRAG API 進行索引，
並支援列出、刪除已索引文件。
...
支援格式：.txt  .md  .rtf  .pdf  .docx  .doc  .odt
         .png  .jpg  .jpeg  .webp  .gif  .bmp（VLM 描述後索引）
"""
...
""",
    ...
    p.add_argument("--api",        default=DEFAULT_API,       help="AgenticRAG API 位址")
