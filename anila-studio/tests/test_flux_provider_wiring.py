...
def reset_studio_module():
    """Reload studio_render (where get_flux_provider + its singleton now live,
    post god-module split) so each test's env changes take effect."""
    import app.services.studio_render as studio
    yield
