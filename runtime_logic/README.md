...
| 對象 | 文件 |
|---|---|
| `openai-agents-python` | [`../docs/agent-framework/runtime-logic-openai-agents-deep-dive.md`](../docs/agent-framework/runtime-logic-openai-agents-deep-dive.md) — 12 條 subsystem 一一拆解 + 對 AgenticRAG 強化的 actionable map（P0–P2 順序與起點檔） |
...
- Parent-child RAG design（Sprint 9 X）：[`../docs/ingestion/parent-child-rag-design.md`](../docs/ingestion/parent-child-rag-design.md)
