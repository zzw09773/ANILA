...
>
> Design authority: [`docs/anila-redesign-docs/00-product-constitution.md`](../../docs/anila-redesign-docs/00-product-constitution.md), [`01-domain-model.md`](../../docs/anila-redesign-docs/01-domain-model.md) (Task domain), [`09-api-event-contracts.md`](../../docs/anila-redesign-docs/09-api-event-contracts.md) (Task / artifact contracts).
...
- Design authority: [`../../docs/anila-redesign-docs/`](../../docs/anila-redesign-docs/) (constitution 00 / domain 01 / contracts 09)
