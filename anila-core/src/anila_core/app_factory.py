"""Application factory for ANILA Core with full RAG stack.
...
async def lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    logger.info("Starting ANILA Core — LLM: %s / model: %s", settings.llm_url, settings.model)
    logger.info("Embedding: %s / model: %s", settings.embedding_url, settings.embedding_model)
