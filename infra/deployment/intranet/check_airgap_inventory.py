...
REQUIRED_ENV = {
    ...
    "STUDIO_ARTIFACT_SERVICE_TOKEN": "csk-studio-artifact-inventory-check",
    "STUDIO_RUNTIME_SERVICE_TOKEN": "csk-studio-runtime-inventory-check",
    "STUDIO_JOB_ENVELOPE_HMAC_KEY": "studio-envelope-inventory-check-0123456789abcdef",
    "INGESTION_QUEUE_HMAC_KEY": "ingestion-queue-inventory-check-0123456789abcdef",
    "EMBEDDING_MODEL_FINGERPRINT": "sha256:" + ("0" * 64),
    "EMBEDDING_MODEL_FINGERPRINT_DEV": "sha256:" + ("1" * 64),
