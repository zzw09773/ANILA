...
> **Reads alongside**: `docs/archive/agent-framework/anila-agent-framework-architecture.md` (canonical architecture spec)
...
**Last updated**: 2026-05-02 (v2) · **v0.1 estimate**: ~3,400 LOC + RAG demos in 4 sprints (~8 weeks) · **Architecture spec**: `docs/archive/agent-framework/anila-agent-framework-architecture.md`
