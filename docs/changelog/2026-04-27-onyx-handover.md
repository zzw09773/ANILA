...
| Handover specs | `docs/onyx/onyx-application-plan.md` + `docs/onyx/onyx-target-system-api-spec.md` | 保留 |
...
- [ ] **Notify agent team**：他們的 Onyx 程式碼專屬 repo URL 應記錄在 [`docs/onyx/onyx-application-plan.md`](../onyx/onyx-application-plan.md) 的 `## Repo location` section（如果還沒，補上）
