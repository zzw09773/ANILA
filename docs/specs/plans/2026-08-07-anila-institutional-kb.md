...
- Modify: `docs/archive/handoffs/HANDOFF-2026-08-07.md`（兩處：§二進度表更新為十任務全關；
  加「本包留下什麼要長期照顧」一節，內容見 Step 3）
- Modify: `docs/archive/handoffs/HANDOFF-2026-08-06.md:230`（alembic head 寫 `r1_0032` → 實際 `r1_0034`；
  Task 1 遞延至今）
